...
public class SlidingMenuFragment extends ListFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mAdapter.add(new MenuItem(Constants.MENU_ITEM_THEMES, getResources().getString(R.string.themes_menu_item), R.drawable.sliding_menu_icon_themes, MenuItemAdapter.TYPE_MAIN));
		mAdapter.add(new MenuItem(Constants.MENU_ITEM_COLOR_PICKER, getResources().getString(R.string.color_picker_menu_item), R.drawable.sliding_menu_icon_color_picker, MenuItemAdapter.TYPE_MAIN));
		mAdapter.add(new MenuItem(Constants.MENU_ITEM_NEWSFEED, getResources().getString(R.string.newsfeed_menu_item), R.drawable.sliding_menu_icon_newsfeed, MenuItemAdapter.TYPE_MAIN));
		mAdapter.add(new MenuItem(Constants.MENU_ITEM_FRIENDS, getResources().getString(R.string.friends_menu_item), R.drawable.sliding_menu_icon_friends, MenuItemAdapter.TYPE_MAIN));
		mAdapter.add(new MenuItem(Constants.MENU_ITEM_PHOTOS, getResources().getString(R.string.photos_albums_menu_item), R.drawable.sliding_menu_icon_albums, MenuItemAdapter.TYPE_MAIN));
		mAdapter.add(new MenuItem(Constants.MENU_ITEM_NOTIFICATIONS, getResources().getString(R.string.notifications_menu_item), R.drawable.sliding_menu_icon_notifications, MenuItemAdapter.TYPE_MAIN));
		mAdapter.add(new MenuItem(Constants.MENU_ITEM_MESSAGES, getResources().getString(R.string.messages_menu_item), R.drawable.sliding_menu_icon_messages, MenuItemAdapter.TYPE_MAIN));

		if (!FBClientApplication.getApplication().hasKindleFeatureSet()) {
			mAdapter.add(new MenuItem(Constants.MENU_ITEM_CHECKINS, getResources().getString(R.string.checkins_menu_item), R.drawable.sliding_menu_icon_checkins, MenuItemAdapter.TYPE_MAIN));
			mAdapter.add(new MenuItem(Constants.MENU_ITEM_SUB_ITEM_FRIENDS_RECENT, getResources().getString(R.string.friends_recent_menu_item), R.drawable.sliding_menu_icon_submenu_mid,
					MenuItemAdapter.TYPE_SUB_MID));
			mAdapter.add(new MenuItem(Constants.MENU_ITEM_SUB_ITEM_NEARBY_LOCATIONS, getResources().getString(R.string.nearby_locations_menu_item), R.drawable.sliding_menu_icon_submenu_end,
	...
	private class MenuItem {
		...
		public MenuItem(String tag, String displayName, int iconRes, int type) {
			this.name = tag;
	...
	public class MenuItemAdapter extends ArrayAdapter<MenuItem> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.title.setText(this.getItem(position).getDisplayName());
