...
final class ViewHolder {
	...
	private RelativeLayout.LayoutParams buildImageLayoutParams(Crouton crouton) {
		...
		RelativeLayout.LayoutParams imageLayoutParams = new RelativeLayout.LayoutParams(croutonHeightInPixels, croutonHeightInPixels);
	...
	public static View buildViewForCrouton(Crouton crouton) {
		...
		//Added by Gunnar Karlsson 12/3/2012 to allow subtle alpha effect on Crouton.
		viewHolder.view.setAlpha(0.9F);
	...
	private static Drawable getCroutonBackgroundDrawable(Crouton crouton) {
		...
		Bitmap backgroundBitmap = BitmapFactory.decodeResource(croutonActivityResources, crouton.getStyle().backgroundDrawableResourceId);
